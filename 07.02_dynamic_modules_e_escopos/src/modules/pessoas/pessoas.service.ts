...
@Injectable(
  //{ scope: Scope.DEFAULT } // Scope.DEFAULT é o padrão, então não é necessário informar, em C# seria Singleton
  //{ scope: Scope.REQUEST } // Scope.REQUEST é um escopo por requisição, em C# seria Scoped
  //{ scope: Scope.TRANSIENT } // Scope.TRANSIENT é um escopo por instância, em C# seria Transient
)
