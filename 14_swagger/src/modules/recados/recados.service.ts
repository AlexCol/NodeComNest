...
export class RecadosService {
  ...
  async findAll(userId: number, page: number, limit: number = 0): Promise<ResponseRecadoDto[]> {
    const take = limit;
  ...
  async findById(userId: number, id: number): Promise<ResponseRecadoDto> {
  ...
  async create(deId: number, recadoDto: CreateRecadoDto): Promise<ResponseRecadoDto> {
  ...
  async update(userId: number, id: number, recadoDto: UpdateRecadoDto): Promise<ResponseRecadoDto> {
  ...
  async remove(userId: number, id: number): Promise<ResponseRecadoDto> {
    const recado = await this.findById(userId, id);
